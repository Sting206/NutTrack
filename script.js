...
function saveGoals() {
  GOALS.kcal = parseInt(document.getElementById('targetKcal').value) || 2800;
  GOALS.protein = parseInt(document.getElementById('targetProtein').value) || 160;
  GOALS.carbs = parseInt(document.getElementById('targetCarbs').value) || 350;
  GOALS.fat = parseInt(document.getElementById('targetFat').value) || 80;
  GOALS.water = parseInt(document.getElementById('targetWater').value) || 2500;
  GOALS.targetWeight = parseFloat(document.getElementById('targetWeight').value) || 82;
...
function loadSavedGoals() {
  ...
  if (savedGoals) {
    ...
    GOALS.kcal = parsed.kcal || 2800;
    GOALS.protein = parsed.protein || 160;
    GOALS.carbs = parsed.carbs || 350;
    GOALS.fat = parsed.fat || 80;
    GOALS.water = parsed.water || 2500;
    GOALS.targetWeight = parsed.targetWeight || 82;
    updateGoalsDisplay();
  }
}
